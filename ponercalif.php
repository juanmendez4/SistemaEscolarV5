...
<div class="body">
    <div class="panel">
           ...
           if(!isset($_GET['revisar'])){
            ...
            <form method="get" class="form" action="notas.view.php">
                ...
                <br><br>
                <button type="submit" name="revisar" value="1">Ingresar calificacion</button> <a class="btn-link" href="listadonotas.view.php">Consultar calificacion</a>
                <br><br>
            </form>
        <?php
           }
 ...
 where id_grado = ".$id_grado." and id_seccion = ".$id_seccion." group by a.id");
            ...
            <table class="table" cellpadding="0" cellspacing="0">
                <tr>
                    <th>num de lista</th><th>Apellidos</th><th>Nombres</th>
                    <?php
                ...
                <br>
                <button type="submit" name="insertar">Guardar</button> <button type="reset">Limpiar</button> <a class="btn-link" href="listadonotas.view.php">Consultar calificacion</a>
                <br>
            </form>
