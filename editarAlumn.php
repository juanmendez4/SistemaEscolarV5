...
<body>
<div class="header">
        <h1>Registro de alumnos: Centro de Bachillerato Industrial y de Servicios 253</h1>
...
<nav>
    <ul>
        ...
        <li><a href="notas.view.php">Registro de calificacion</a> </li>
        <li><a href="listadonotas.view.php">Consulta la calificacion </a> </li>
...
<div class="body">
    <div class="panel">
            ...
            <form method="post" class="form" action="procesaralumno.php">
                ...
                <br><br>
                <label>numero de Lista</label><br>
                ...
                <br><br>
                <button type="submit" name="modificar">Guardar Cambios</button> <a class="btn-link" href="listadoalumnos.view.php">Ver registro</a>
                <br><br>
